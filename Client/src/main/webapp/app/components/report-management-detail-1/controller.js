app.controller('reportManagementDetail1ModalController', function($rootScope, $scope, $mdDialog,requestManager, userManager, $filter, DIVISION_ACCESS, AuthService, dateTimeFilter, commentManager) {
