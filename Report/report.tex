...
\end{itemize}
Tiếp theo, chúng tôi xin giới thiệu một số thông tin cơ bản về chuẩn GeoReport v2
\paragraph{Quốc tế hóa và mã hóa}
\paragraph*{Định dạng ngày/giờ}
Mọi ô dữ liệu kiểu ngày/giờ phải định dạng theo một tập con chung của chuẩn ISO 8601. Thông tin về vùng giờ phải có trong định dạng.
...
%TODO Hỏi thầy có cần làm cái này ko?
