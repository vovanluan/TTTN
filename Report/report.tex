...
\begin{center}
    \begin{figure}[h]
    \begin{center}
     \includegraphics[scale=.7]{class-diagram.png}
    \end{center}
...
=======
	\item[•]Trang cá nhân: Nếu người dùng đã đăng nhập vào hệ thống, người dùng có thể truy cập vào trang cá nhân để xem hoặc cập nhật thông tin của người dùng như tên, số chứng minh nhân dân, email, số điện thoại...
	%Thêm ảnh	
\end{itemize}

>>>>>>> 21afd6958ded816fc885d5354c7c1a5d27372bc6
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
