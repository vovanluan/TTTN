...
\begin{center}
    \begin{figure}[h]
    \begin{center}
     \includegraphics[scale=.4]{gopy-tphcm.PNG}
    \end{center}
    \caption{Trang góp ý của \href{hochiminhcity.gov.vn}{hochiminhcity.gov.vn}}
    \label{refhinh7}
    \end{figure}
\end{center}
...
\begin{center}
    \begin{figure}[h]
    \begin{center}
     \includegraphics[scale=.3]{egov-danang.PNG}
    \end{center}
    \caption{Trang web CPĐT \href{egov.danang.gov.vn}{egov.danang.gov.vn} của Thành phố Đà Nẵng}
    \label{refhinh7}
    \end{figure}
\end{center}
...
REST (Representational State Transfer) định nghĩa các quy tắc kiến trúc thiết kế Web services chú trọng vào tài nguyên hệ thống, các tài nguyên này được chuyển tải thông qua giao thức HTTP. REST được giới thiệu lần đầu tiên vào năm 2000 bởi Roy Fielding trong luận án của ông "Architectural Styles and the Design of Network-based Software Architectures".\\
\\
Việc cụ thể hóa một Web service REST sẽ tuân thủ theo bốn nguyên tắc thiết kế cơ bản sau:
 \begin{itemize}
